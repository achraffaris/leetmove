"""
Django settings for leetest project.
...
SECRET_KEY = 'django-insecure-8%wxm&o6cgm^*o*lunkqm-ek_-*$s^_nlqv_jgi-khl5kl4m&c'
...
WSGI_APPLICATION = 'leetest.wsgi.application'
